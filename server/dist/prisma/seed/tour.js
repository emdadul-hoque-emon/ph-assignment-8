...
exports.toursData = [
    // 1. Shanghai (1 tour)
    {
        ...
        description: "Experience the vibrant mix of modern skyscrapers and historical architecture across the Bund and Pudong.",
        destinationId: "ab9e3d9e-9f6e-49cb-9b2c-2dcbfe9093a5",
        createdById: CREATOR_ID,
        durationDays: 3,
        maxGroupSize: 15,
        priceFrom: 399.0,
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.CITY,
        image: "https://images.unsplash.com/photo-1474181487882-5abf3f0ba6c2?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Arrival & The Bund",
                    description: "Evening walk along the historic Bund overlooking the futuristic skyline.",
                    location: "The Bund",
                    duration: "3 hours",
                    icon: "building",
                },
                ...
                },
                {
                    ...
                    description: "Ascend one of the world's tallest buildings before departure.",
                    location: "Pudong",
                    duration: "4 hours",
                    icon: "arrow-up",
                },
    ...
    // 2. Miami (2 tours)
    {
        ...
        description: "Stroll through the colorful history of South Beach's iconic architecture.",
        ...
        priceFrom: 89.0,
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.CULTURE,
        image: "https://images.unsplash.com/photo-1533682805518-48d1f5a8bb38?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    },
    {
        ...
        description: "Skip the lines at Miami's most exclusive beach clubs and lounges.",
        destinationId: "afc72905-8170-425f-b4bb-9e6867ec44b0",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 8,
        priceFrom: 250.0,
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.NIGHTLIFE,
        image: "https://images.unsplash.com/photo-1572945205423-cb873099ea6e?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    // 3. Hanoi (1 tour)
    {
        ...
        description: "Taste the authentic flavors of Vietnam in the bustling alleyways of Hanoi.",
        ...
        priceFrom: 45.0,
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.FOOD,
        image: "https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    // 4. Las Vegas (1 tour)
    {
        ...
        description: "See the neon lights from above and learn the secrets of the mega-casinos.",
    ...
    // 5. Taipei (1 tour)
    {
        ...
        maxGroupSize: 12,
        priceFrom: 120.0,
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.CULTURE,
    ...
    // 6. San Francisco (2 tours)
    {
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.CITY,
        image: "https://images.unsplash.com/photo-1501594907352-04cda38ebc29?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Bike & Boat",
                    description: "Morning bridge bike ride, afternoon Alcatraz audio tour.",
    ...
    // 8. Vancouver (1 tour)
    {
        ...
        priceFrom: 210.0,
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.NATURE,
        image: "https://images.unsplash.com/photo-1559511260-66a654ae982a?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    // 9. Phuket (3 tours)
    {
        ...
        priceFrom: 85.0,
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.BEACH,
        image: "https://images.unsplash.com/photo-1589394815804-964ce0fa58f4?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    },
    {
        ...
        description: "An ethical half-day visit to feed and walk with rescued elephants.",
        destinationId: "c0b27788-6356-40d9-9931-480ec1e7051d",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 15,
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.NATURE,
        image: "https://images.unsplash.com/photo-1583002228352-7104b901a88b?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    // 10. Cairo (1 tour)
    {
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.CULTURE,
        image: "https://images.unsplash.com/photo-1539650116574-8efeb43e2b50?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Giza Plateau",
                    description: "Camel ride, Sphinx visit, and entry to the Great Pyramid.",
                    location: "Giza",
                    duration: "6 hours",
                    icon: "camera",
                },
    ...
    // 11. Buenos Aires (1 tour)
    {
        ...
        description: "Experience the passion of Argentina through its dance and wine.",
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.NIGHTLIFE,
        image: "https://images.unsplash.com/photo-1583335513577-224b423f5b02?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Dinner & Show",
                    description: "Premium steak dinner followed by a professional Tango show.",
                    location: "San Telmo",
                    duration: "4 hours",
                    icon: "music",
                },
    ...
    // 13. Hong Kong (1 tour)
    {
        ...
        description: "Panoramic city views followed by a Michelin-star dim sum lunch.",
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.FOOD,
        image: "https://images.unsplash.com/photo-1507941097613-9f2157b69235?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    // 14. Venice (1 tour)
    {
        ...
        description: "A private gondola ride and walking tour of the hidden sestieri.",
            ...
            createMany: [
                {
                    ...
                    description: "Explore the Rialto market and glide through quiet canals.",
                    location: "San Polo",
                    duration: "3 hours",
                    icon: "anchor",
                },
    ...
    // 15. Honolulu (1 tour)
    {
        ...
        description: "Pay respects at the USS Arizona, then sail the Waikiki coast.",
            ...
            createMany: [
                {
                    dayNumber: 1,
                    title: "The Souks",
                    description: "Guided shopping and haggling through the chaotic markets.",
                    location: "Medina",
                    duration: "4 hours",
                    icon: "shopping-bag",
                },
                {
                    dayNumber: 2,
                    title: "Bahia Palace",
                    description: "Explore intricate Islamic architecture and peaceful courtyards.",
                    location: "Mellah",
                    duration: "3 hours",
                    icon: "camera",
                },
    ...
    // 17. Queenstown (2 tours)
    {
        ...
        description: "Get your adrenaline pumping in the adventure capital of the world.",
        destinationId: "5514f1ca-bff4-4ca3-abbd-ee0cf1df9aa6",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 10,
        priceFrom: 295.0,
        difficulty: enums_1.TourDifficulty.HARD,
        category: enums_1.TourCategory.ADVENTURE,
        image: "https://images.unsplash.com/photo-1528644406155-231a4030d97d?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    },
    {
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.NATURE,
        image: "https://images.unsplash.com/photo-1600206126600-b6f70a92f026?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    // 18. Seoul (1 tour)
    {
        ...
        description: "Contrast the ancient Hanok villages with modern K-Pop culture.",
        ...
        itineraries: {
            createMany: [
                ...
                },
                {
                    dayNumber: 2,
                    title: "Gangnam Style",
                    description: "Visit famous K-Pop agency buildings and shopping streets.",
                    location: "Gangnam",
                    duration: "4 hours",
                    icon: "music",
                },
    ...
    // 19. Banff (1 tour)
    {
        ...
        description: "Hike the majestic trails around Lake Louise and Moraine Lake.",
    ...
    // 21. Prague (1 tour)
    {
        ...
        description: "Explore the magical bridges and gothic architecture of Bohemia.",
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.CITY,
        image: "https://images.unsplash.com/photo-1519677100203-a0e668c92439?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
    ...
    // 22. Cusco (1 tour)
    {
        ...
        description: "Journey through the heart of the Inca Empire to the lost city.",
    ...
    // 25. London (1 tour)
    {
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.CITY,
        image: "https://images.unsplash.com/photo-1513635269975-59693e0cd156?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Tower to Palace",
                    description: "Tower of London, Westminster Abbey, and Buckingham Palace.",
    ...
    // 27. Santorini (1 tour)
    {
        ...
        description: "Sail a catamaran in the caldera and watch the world's best sunset.",
    ...
    // 28. Rio de Janeiro (1 tour)
    {
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.CITY,
        image: "https://images.unsplash.com/photo-1483729558449-99ef09a8c325?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Corcovado & Beach",
                    description: "Train ride up the mountain followed by Caipirinhas on the beach.",
            ...
            createMany: [
                {
                    ...
                    description: "Private inside tour of the Opera House and Harbour cruise.",
    ...
    // 31. New York (1 tour)
    {
        ...
        description: "The ultimate NYC experience from Central Park to Times Square.",
            ...
            createMany: [
                {
                    ...
                    description: "Bike tour of the park and sunset views from Rockefeller.",
                    location: "Midtown",
                    duration: "6 hours",
                    icon: "building",
                },
            ...
            createMany: [
                {
                    dayNumber: 1,
                    title: "Cruise & Haggle",
                    description: "Morning boat tour, afternoon at the Spice Market and Grand Bazaar.",
    ...
    // 34. Bangkok (1 tour)
    {
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.FOOD,
        image: "https://images.unsplash.com/photo-1583417657207-bdaaf09df559?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Tuk-Tuk Adventure",
                    description: "Zip through the city trying Pad Thai, Satay, and Mango Sticky Rice.",
                    location: "Chinatown",
                    duration: "5 hours",
                    icon: "utensils",
                },
            ...
            createMany: [
                {
                    ...
                    description: "Private boat ride, reef snorkeling, and isolated beach BBQ.",
    ...
    // 37. Tokyo (1 tour)
    {
        ...
        description: "Dive into the vibrant, chaotic, and fascinating nightlife of Tokyo.",
            ...
            createMany: [
                {
                    ...
                    description: "Crossing Shibuya, arcade hopping, and hidden alleyway dining.",
                    location: "Shinjuku",
                    duration: "5 hours",
                    icon: "moon",
                },
        ...
        itineraries: {
            createMany: [
                ...
                },
                {
                    dayNumber: 2,
                    title: "Dune Bashing",
                    description: "4x4 desert safari, camel ride, and Bedouin camp dinner.",
            ...
            createMany: [
                {
                    ...
                    description: "Explore the sacred sanctuary and local artisan markets.",
                    location: "Ubud",
                    duration: "5 hours",
                    icon: "tree",
                },
                {
                    ...
                    description: "Hike the rice terraces and swing over the jungle canopy.",
    ...
    // 41. Tokyo (2nd tour)
    {
        ...
        description: "Navigate the bustling outer market and learn the art of sushi from a master.",
        destinationId: "feca4109-3e24-4fcd-937c-ca48d75b6fb0",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 8,
            ...
            createMany: [
                {
                    ...
                    description: "Morning ingredient shopping followed by a hands-on sushi class.",
                    location: "Tsukiji",
                    duration: "4 hours",
                    icon: "utensils",
                },
    ...
    // 42. Paris (2nd tour)
    {
        ...
        description: "Taste your way through the bohemian district of artists and dreamers.",
        destinationId: "612ab95c-8970-4075-bbe5-df7b6f6b53bf",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 10,
            ...
            createMany: [
                {
                    ...
                    description: "Visit local boulangeries, fromageries, and wine cellars.",
    ...
    // 43. Rome (2nd tour)
    {
        ...
        description: "Discover Rome's most charming neighborhood through its best local trattorias.",
        destinationId: "a8ef302f-39a3-4783-8308-fc01d6324143",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 12,
            ...
            createMany: [
                {
                    dayNumber: 1,
                    title: "Pasta & Gelato",
                    description: "Evening walking tour with 5 tasting stops, ending with artisanal gelato.",
                    location: "Trastevere",
                    duration: "4 hours",
                    icon: "moon",
                },
    ...
    // 44. London (2nd tour)
    {
        ...
        description: "A chilling evening walk tracing London's darkest history, with pint stops.",
        destinationId: "d8a76793-1b4b-442e-bd5b-af358fdcb9a9",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 15,
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.NIGHTLIFE,
        image: "https://images.unsplash.com/photo-1521319220054-94c34a2c2621?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "East End Shadows",
                    description: "Guided walk through Whitechapel with stops at Victorian pubs.",
                    location: "East End",
                    duration: "3 hours",
                    icon: "glass",
                },
    ...
    // 45. New York (2nd tour)
    {
        ...
        description: "Walk the iconic bridge and eat your way through Brooklyn's trendy waterfront.",
        destinationId: "4b472e4e-3e41-47dd-afc4-f4d2a7ec4fb8",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 14,
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.FOOD,
        image: "https://images.unsplash.com/photo-1496886008898-0c622a450e1d?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Pizza & Skyline Views",
                    description: "Bridge walk followed by Grimaldi's pizza and local sweets.",
                    location: "Brooklyn",
                    duration: "4 hours",
                    icon: "camera",
                },
    ...
    // 46. Amsterdam (2nd tour)
    {
        ...
        description: "An informative and respectful walking tour of Amsterdam's oldest neighborhood.",
        destinationId: "de60bfb8-e6dc-44ce-8455-e570825eed92",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 12,
    ...
    // 47. Barcelona (2nd tour)
    {
        ...
        description: "Escape the city for a day of crystal-clear waters and hidden sea caves.",
        destinationId: "e308f781-45c5-4e5a-8cee-1568086c7fc8",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 10,
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.BEACH,
        image: "https://images.unsplash.com/photo-1506509618585-1d488c9f5647?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Mediterranean Adventure",
                    description: "Roundtrip transport, guided kayaking, and beach picnic.",
    ...
    // 48. Singapore (2nd tour)
    {
        ...
        description: "Ziplines, universal studios, and indoor skydiving on Asia's playground.",
        destinationId: "9bff344d-e90e-4998-b5c1-ca96e7869113",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 15,
        ...
        difficulty: enums_1.TourDifficulty.HARD,
        category: enums_1.TourCategory.ADVENTURE,
        image: "https://images.unsplash.com/photo-1542158097-909249764516?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Thrill Seeker's Day out",
                    description: "MegaZip over the jungle, followed by iFly and Luge rides.",
    ...
    // 49. Bangkok (2nd tour)
    {
        ...
        description: "Witness the unique chaos of markets built on water and active train tracks.",
        destinationId: "bf9f1366-5e83-4df4-801b-f09dcbc36f09",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 12,
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.CULTURE,
        image: "https://images.unsplash.com/photo-1510410714152-7cd0c4c47bb6?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Train & Boat Markets",
                    description: "Maeklong Railway Market and Damnoen Saduak Floating Market.",
    ...
    // 50. Dubai (2nd tour)
    {
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.BEACH,
        image: "https://images.unsplash.com/photo-1506501139174-099022df5260?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Yacht Life",
                    description: "Afternoon cruise past the Palm Jumeirah and Burj Al Arab.",
    ...
    // 51. Cape Town (2nd tour)
    {
        ...
        description: "Sip South Africa's finest vintages amidst rolling green vineyards.",
        destinationId: "da6c1197-d840-4236-be1a-c6f343a3d19a",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 10,
            ...
            createMany: [
                {
                    ...
                    description: "Cellar tours and tastings at three premium wine estates.",
    ...
    // 52. Kyoto (2nd tour)
    {
        ...
        description: "Immerse yourself in ancient Japanese arts with local masters.",
        destinationId: "6c956803-9918-4f23-9f56-226c1994625a",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 6,
            ...
            createMany: [
                {
                    dayNumber: 1,
                    title: "Zen Arts",
                    description: "Traditional tea preparation followed by a Shodo (calligraphy) lesson.",
    ...
    // 53. Las Vegas (2nd tour)
    {
        ...
        description: "Leave the neon behind for one of the natural wonders of the world.",
        destinationId: "7ca4b9da-155c-4fd6-91a2-1a3a8cdfda55",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 24,
            ...
            createMany: [
                {
                    ...
                    description: "Bus tour to the West Rim with an optional Skywalk upgrade.",
    ...
    // 54. Hong Kong (2nd tour)
    {
        ...
        description: "Ride a glass-bottom cable car to visit the majestic Tian Tan Buddha.",
        destinationId: "efb1f52d-2a09-4ecd-8b17-868b9e19314d",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 15,
        ...
        difficulty: enums_1.TourDifficulty.MODERATE,
        category: enums_1.TourCategory.CULTURE,
        image: "https://images.unsplash.com/photo-1541079366657-3a18012b1860?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
                    title: "Ngong Ping 360",
                    description: "Cable car ride, Po Lin Monastery, and vegetarian lunch.",
    ...
    // 55. Denpasar / Bali (2nd tour)
    {
        ...
        description: "VIP beds, sunset cocktails, and DJ sets at Bali's premier day clubs.",
        destinationId: "5e0693d6-c7fe-4d30-97a8-35ca2fdde221",
        createdById: CREATOR_ID,
        durationDays: 1,
        maxGroupSize: 8,
        ...
        difficulty: enums_1.TourDifficulty.EASY,
        category: enums_1.TourCategory.NIGHTLIFE,
        image: "https://images.unsplash.com/photo-1516483638261-f40af5aa11ce?auto=format&fit=crop&q=80&w=1000",
        itineraries: {
            createMany: [
                {
                    dayNumber: 1,
